package code {
   ...
   import flash.net.*;
	...
	public class Logic extends MovieClip{
		...
		//Set of booleans checking if the arrow keys are pressed.
		private var upIsPressed:Boolean = false;
		private var rightIsPressed:Boolean = false;
		private var leftIsPressed:Boolean = false;
		private var downIsPressed:Boolean = false;
